...
let createPlaylistURL = "https://api.spotify.com/v1/users/31s5fcbgzo3pkww6ancnzov63cjm";
...
const newPlaylistBody = {
  ...
  description: "the best bad bunny playlist",
  public: true,
};
...
const response = await fetch(createPlaylist, options);
...
let addingSongsURL = "https//api.spotify.com/v1/playlists/3RQQmkQEvNCY4prGKE6oc5/tracks";
...
const songs = [
  "spotify:track:1dm6z1fWB0cErMszU25dy2",
  "spotify:track:1IHWl5LamUGEuP4ozKQSXZ",
  "spotify:track:6Sq7ltF9Qa7SNFBsV5Cogx",
  "spotify:track:71wFwRo8xGc4lrcyKwsvba",
];
...
async function addPlaylistSongs(addPlaylistSong) {
  ...
  const options = {
    ...
    body: JSON.stringify(addPlaylistSong),
